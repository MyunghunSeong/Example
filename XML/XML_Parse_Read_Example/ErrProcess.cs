...
namespace CMS_G.sub.Err
{
    ...
    public class _TargetSelectDlgException : ErrProcess
    {
        public _TargetSelectDlgException()
        {}

        public _TargetSelectDlgException(Int16 errCode)
            : base(errCode)
        {}
    }
    public class _TargetReaderDlgException : ErrProcess
    {
        public _TargetReaderDlgException()
        { }

        public _TargetReaderDlgException(Int16 errCode)
            : base(errCode)
        { }
    }
    public class _NAInspectException : ErrProcess
    {
        public _NAInspectException()
        { }

        public _NAInspectException(Int16 errCode)
            : base(errCode)
        { }
    }
    ...
    public class _AIOInspectException : ErrProcess
    {
        public _AIOInspectException()
        { }

        public _AIOInspectException(Int16 errCode)
            : base(errCode)
        { }
    }
    public class _SPInspectException : ErrProcess
    {
        public _SPInspectException()
        { }

        public _SPInspectException(Int16 errCode)
            : base(errCode)
        { }
    }
    public class _PowLibException : ErrProcess
    {
        public _PowLibException()
        {}

        public _PowLibException(Int16 errCode)
            : base(errCode)
        {}
    }
